...
func Load() Config {
	...
	config.PostgresHost = cast.ToString(getOrReturnDefaultValue("POSTGRES_HOST", "postgres-tender"))
	...
	config.RedisHost = cast.ToString(getOrReturnDefaultValue("REDIS_HOST", "redis"))
